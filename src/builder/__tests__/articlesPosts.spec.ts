...
import { parseRSSFeed,getOgImagePath ,getArticlePost,getMembersPosts} from "../articlesPosts";
...
describe("Articlesposts", () => {
  ...
  describe("getArticlePost",()=>{
    test("", async () => {
      const member:Member = {name:"PoPodada",feedLinks:["https://qiita.com/PoPodada/feed","https://qiita.com/PoPodada/feed"]}
  ...
  describe("getMembersPost",()=> {
    test("複数の記事サイトから記事を取得する",async()=>{
      const members:Member[] = [
        {
        name:"PoPodada0",
        feedLinks:["https://qiita.com/PoPodada/feed","https://qiita.com/PoPodada/feed"]
        },
        {
          name:"PoPodada1",
          feedLinks:["https://qiita.com/PoPodada/feed","https://qiita.com/PoPodada/feed"]
    ...
    const results = await getMembersPosts(members);
      expect(results).toEqual(
        [{
        title: "ハッカソンに参加する良さについて",
        url: "https://qiita.com/PoPodada/items/30bdf57e1d3ea7bc070b",
